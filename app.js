...
import { render } from "https://cdn.skypack.dev/tacocat";
const goog = {require() {console.log("goog.require() called; not doing anything")}, provide() {console.log("goog.provide() called; not doing anything")}}
Blockly.FtcJava = {};
...
Promise.all(blockDefinitions).then(files => Promise.all(files.map(async f => {
    eval(await f.text());
